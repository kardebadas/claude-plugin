...
| [`pipeline`](skills/pipeline) | `superb:pipeline` | Takes a settled idea to a finished branch: design gate, master plan, phase expansion, plan gate, then an autonomous per-phase implement/review/fix loop where a phase, never a task, is the unit of review and of acceptance. |
