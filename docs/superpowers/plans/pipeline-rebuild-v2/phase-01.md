...
- [ ] **GREEN check.**
  ...
  Expected: PASS; phase review is impossible before mechanical verification, no fourth round exists without exact finite authority, and D-021 cannot authorize Round 5.
